          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl border-2 border-[#D8C2B8] shadow-md space-y-3 font-body text-sm text-[#1C121B]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 font-semibold text-xs sm:text-sm">
                <p className="flex items-center gap-2"><CheckCircle size={18} className="text-[#2E4323]" weight="fill" /> 45-60 minute relaxed studio shoot</p>
                <p className="flex items-center gap-2"><CheckCircle size={18} className="text-[#2E4323]" weight="fill" /> Group family poses & individual child portraits</p>
                <p className="flex items-center gap-2"><CheckCircle size={18} className="text-[#2E4323]" weight="fill" /> Games & gentle activities to prompt real smiles</p>
                <p className="flex items-center gap-2"><CheckCircle size={18} className="text-[#2E4323]" weight="fill" /> Outfit styling advice before your date</p>
