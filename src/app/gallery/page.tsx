...
export const metadata: Metadata = {
  title: "Photography Gallery Northfield, Adelaide | Falguni's Photography",
  description: "Browse real newborn, maternity, and family photography sessions from Falguni's Photography in Northfield, Adelaide. See the style before you book.",
};
