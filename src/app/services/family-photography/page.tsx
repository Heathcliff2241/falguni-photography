    ...
    <div className="py-12 bg-[#FBF6EF] space-y-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-body text-xs font-semibold uppercase tracking-widest text-[#A7B596]">
                Relaxed & Playful • Northfield Studio
              </span>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-[#EFD4CE] space-y-3 font-body text-xs text-[#423341]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                <p className="flex items-center gap-2"><CheckCircle size={16} className="text-[#A7B596]" /> Playful games to keep toddlers engaged</p>
                <p className="flex items-center gap-2"><CheckCircle size={16} className="text-[#A7B596]" /> Group family & individual child portraits</p>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center gap-4 font-body">
              <BookSessionButton service="family" label="Book Your Family Session" className="w-full sm:w-auto" />
              <a
          ...
          <div className="lg:col-span-5">
            <div className="bg-white p-4 rounded-3xl shadow-[0_12px_40px_rgba(66,51,65,0.08)] border border-[#EFD4CE] transform -rotate-1">
              ...
              <p className="font-display text-center text-lg text-[#423341] font-medium mt-3">
                Formal Navy Family Session in Northfield
              </p>
            </div>
          </div>
        </div>
        ...
        <FaqAccordion
          ...
          subtitle="Tips for preparing kids and outfit choices before your shoot."
        />
      </div>
    </div>
  );
